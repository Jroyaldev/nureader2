  ...
  return (
    <div className="relative inline-block">
      ...
      {isVisible && (
        <div
          ref={tooltipRef}
          className={`absolute z-[10100] px-3 py-2 text-xs font-medium text-white bg-gray-900 dark:bg-gray-50 dark:text-gray-900 rounded-md shadow-md border border-gray-200 dark:border-gray-800 whitespace-nowrap pointer-events-none transition-opacity duration-200 ${getPositionClasses()}`}
          style={{
