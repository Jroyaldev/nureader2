      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-8 lg:px-12 pb-32">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="reader-floating rounded-2xl p-12 group active:scale-[1.02] transition-all duration-300 touch-manipulation">
               <div className="w-12 h-12 bg-gradient-to-br from-[rgb(var(--accent))] to-[rgb(var(--accent))]/80 rounded-xl flex items-center justify-center mb-6 group-active:scale-110 transition-transform shadow-lg">
