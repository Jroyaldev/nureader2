          ...
          <div className="p-8">
            {!isUploading ? (
              <div
                ...
                className="border-2 border-dashed border-[rgba(var(--muted),0.2)] rounded-2xl p-16 text-center hover:border-blue-500 hover:bg-blue-500/5 transition-all cursor-pointer group"
              ...
              >
                <div className="w-20 h-20 mx-auto mb-6 rounded-[var(--radius-lg)] bg-[rgba(var(--muted),0.06)] flex items-center justify-center group-hover:bg-[rgba(var(--accent),0.08)] transition-colors">
                  <svg className="w-10 h-10 text-muted group-hover:text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
